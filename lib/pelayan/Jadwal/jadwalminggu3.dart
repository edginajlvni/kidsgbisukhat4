...
class JadwalMinggu3 extends StatefulWidget {
  const JadwalMinggu3({super.key});

  @override
  State<JadwalMinggu3> createState() => _JadwalMinggu3State();
}

class _JadwalMinggu3State extends State<JadwalMinggu3> {
