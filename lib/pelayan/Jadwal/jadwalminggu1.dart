...
class JadwalMinggu1 extends StatefulWidget {
  const JadwalMinggu1({super.key});

  @override
  State<JadwalMinggu1> createState() => _JadwalMinggu1State();
}

class _JadwalMinggu1State extends State<JadwalMinggu1> {
